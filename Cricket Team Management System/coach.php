...
?>
    ...
    <div class="action-buttons">
      <a href="addcoach.php"><button class="add-button">Add</button></a>
      <a href="editcoach.php"><button class="edit-button">Edit</button></a>
      <a href="deletecoach.php"><button class="delete-button">Delete</button></a>
    </div>
  </div>
  </div>
